...
#define RL_MAX_MATRIX_STACK_SIZE              4       // Maximum size of internal Matrix stack
...
//------------------------------------------------------------------------------------
#define MAX_MATERIAL_MAPS              1        // Maximum number of shader maps supported
#define MAX_MESH_VERTEX_BUFFERS         1       // Maximum vertex buffers (VBO) per mesh
