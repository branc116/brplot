...
void br_theme_dark(void) {
  ...
  br_theme.colors.btn_inactive = br_color_lighter(bg, 0.1f);
  ...
  br_theme.colors.plot_bg = br_color_lighter(bg, 0.1f);
  br_theme.colors.plot_menu_color = br_color_lighter(bg, 1.2f);
  ...
  br_theme.colors.grid_lines.a = 0x15;
...
void br_theme_light(void) {
  br_color_t bg = BR_COLOR(0xe0, 0xe0, 0xe0, 0x00);
  br_color_t txt = BR_COLOR(0x0f, 0x0f, 0x0f, 0xff);
  
  br_theme.colors.btn_inactive = br_color_darker(bg, 0.1f);
  ...
  br_theme.colors.plot_bg = br_color_darker(bg, 0.1f);
  br_theme.colors.plot_menu_color = br_color_darker(bg, .4f);

  br_theme.colors.grid_nums = txt;
  br_theme.colors.grid_nums_bg = br_theme.colors.plot_bg;
  br_theme.colors.grid_lines = br_color_greener(br_color_lighter(txt, 0.7f), 0.02f);
  br_theme.colors.grid_lines.a = 0x15;
