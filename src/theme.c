...
void br_theme_dark(void) {
  ...
  br_theme.colors.btn_hovered = br_color_greener(br_color_lighter(br_theme.colors.btn_inactive, 1.0f), 0.3f);
  br_theme.colors.btn_active = br_color_lighter(br_theme.colors.btn_hovered, 0.5f);
  br_theme.colors.btn_txt_inactive = txt;
  br_theme.colors.btn_txt_hovered = txt;
