...
void br_resampling_construct(br_shaders_t* shaders, float* min_something, float* cull_min, br_anims_t* anims, br_serieses_t* serieses);
...
void br_resampling_draw(br_resampling_t* res, br_data_t const* pg, br_plot_t* rdi, float pd_thicness, br_extent_t extent);
