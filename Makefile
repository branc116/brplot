...
build/main.o: main.c udp.h graph.h points_group.h smol_mesh.h refresh_shaders.h config.h
	gcc $(CCFLAGS) -c -o build/main.o main.c

build/graph.o: graph.c graph.h points_group.h smol_mesh.h config.h
...
build/points_group.o: points_group.c points_group.h smol_mesh.h config.h
	gcc $(CCFLAGS) -c -o build/points_group.o points_group.c

build/smol_mesh.o: smol_mesh.c smol_mesh.h config.h
