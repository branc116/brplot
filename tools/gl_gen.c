...
struct {
  ...
  },
  {
    ...
    .functions =
      ...
      "GLXContext glXCreateContext(Display* dpy, XVisualInfo* visual, void* shareList, Bool direct)"
      ...
      "GLXFBConfigs glXChooseFBConfig(Display* d, int screen, const int* attribList, int* nitems)"
