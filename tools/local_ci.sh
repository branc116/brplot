...
make $@ PLATFORM=LINUX COMPILER=GCC   CONFIG=DEBUG   GUI=IMGUI    TYPE=LIB  && \
make $@ PLATFORM=LINUX COMPILER=GCC   CONFIG=DEBUG   GUI=RAYLIB   TYPE=LIB  && \
make $@ PLATFORM=LINUX COMPILER=GCC   CONFIG=DEBUG   GUI=HEADLESS TYPE=LIB  && \
make $@ PLATFORM=LINUX COMPILER=GCC   CONFIG=RELEASE GUI=IMGUI    TYPE=LIB  && \
make $@ PLATFORM=LINUX COMPILER=GCC   CONFIG=RELEASE GUI=RAYLIB   TYPE=LIB  && \
make $@ PLATFORM=LINUX COMPILER=GCC   CONFIG=RELEASE GUI=HEADLESS TYPE=LIB  && \
make $@ PLATFORM=LINUX COMPILER=CLANG CONFIG=DEBUG   GUI=IMGUI    TYPE=LIB  && \
make $@ PLATFORM=LINUX COMPILER=CLANG CONFIG=DEBUG   GUI=RAYLIB   TYPE=LIB  && \
make $@ PLATFORM=LINUX COMPILER=CLANG CONFIG=DEBUG   GUI=HEADLESS TYPE=LIB  && \
make $@ PLATFORM=LINUX COMPILER=CLANG CONFIG=RELEASE GUI=IMGUI    TYPE=LIB  && \
make $@ PLATFORM=LINUX COMPILER=CLANG CONFIG=RELEASE GUI=RAYLIB   TYPE=LIB  && \
make $@ PLATFORM=LINUX COMPILER=CLANG CONFIG=RELEASE GUI=HEADLESS TYPE=LIB  && \
